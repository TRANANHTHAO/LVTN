...
3. If you need only the changed files for mobile apps in V4.2 check the update files in update files for apps from V4.1 to V4.2 folder. Please try to run this change log folder. 
